...
title_mapping = {"Mr": 1, "Miss": 2, "Mrs": 3, "Master": 4, "Dr": 5, "Rev": 6, "Major": 7, "Col": 7, "Mlle": 2,
...
#
#
# cross_validation = cross_validation.StratifiedKFold(target, n_folds=3)
...
#  {'min_samples_split': 4, 'n_estimators': 250, 'criterion': 'entropy', 'max_depth': 8, 'class_weight': 'balanced'}
rfc = RandomForestClassifier(n_estimators=250, min_samples_split=4,
                             criterion='entropy', max_depth=8, class_weight='balanced')
